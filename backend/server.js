...
app.use(cors({
  origin: [
    ...
    "http://13.53.42.75:8020",
    "http://13.53.42.75:5500",
    "http://13.53.42.75:8021",
    "http://13.53.42.75:8010",
    "http://13.53.42.75:8011",
...
// Start server
app.listen(port, () => {
  console.log(`Server running on http://13.53.42.75:${port}`);
});
