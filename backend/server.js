...
const pool = new Pool({
  ...
  host: process.env.DB_HOST || 'job_postgres',
...
app.use(cors({
  origin: [
    ...
    "http://51.20.65.33:8020",
    "http://51.20.65.33:5500",
    "http://51.20.65.33:8021",
    "http://51.20.65.33:8010",
    "http://51.20.65.33:8011",
...
// Start server
app.listen(port, () => {
  console.log(`Server running on http://51.20.65.33:${port}`);
});
